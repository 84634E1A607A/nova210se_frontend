        ...
        <div>
          <label htmlFor="user_name" className="block text-left">
            ...
            <input
              ...
              className={`${getEditorStyle(errors.user_name)} surface-0 mt-1 block w-60 rounded-md 
        ...
        <div>
          <label htmlFor="password" className="mt-5 block text-left">
            ...
            <input
              ...
              className={`${getEditorStyle(errors.password)} surface-0 mt-1 block w-60 rounded-md border border-slate-300 px-3 py-2 text-sm placeholder-slate-400 shadow-sm
                focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500
